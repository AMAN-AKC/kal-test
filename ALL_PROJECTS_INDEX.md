...
3. final_year_project/placements/views.py
   ...
   - amazon_list: filters Placement with company\_\_icontains='amazon' (case-insensitive)
...
3. faculty_project/faculty/views.py
   ...
   - cse_professors: filters Faculty with branch**iexact='CSE' AND title**iexact='Professor'
...
3. hr_project/employees/views.py
   ...
   - high_salary: filters Employee with salary\_\_gt=50000
